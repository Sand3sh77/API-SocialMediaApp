...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "SELECT DISTINCT stories.id, stories.img, stories.createdAt, stories.userId, users.name, users.profilePic ,users.method
    FROM stories 
    ...
    $sql1 = "SELECT DISTINCT stories.id, stories.img, stories.createdAt, stories.userId, users.name, users.profilePic ,users.method
    FROM stories 
    INNER JOIN users ON stories.userId = users.id 
